package com.awsdevelop.ducbm.awsexamdevelop;
...
public class ExamActivity  extends ActionBarActivity {
    ...
    private void SetupViewExam()
    {
        ...
        ExamAdapter examAdapter = new ExamAdapter(this,q,totalQuestion,subjectlanguage,number);
    ...
    private void ShowExplain() {
        if ( !subjectlanguage.equals("AWS-ArchitectExam") || number>4)
        {

            Toast toast = Toast.makeText(getApplicationContext(), "Please buy full version", Toast.LENGTH_SHORT);
            toast.show();

            Uri uri = Uri.parse("https://play.google.com/store/apps/details?id=awsexampayment.com.ducbm.awsexampayment");
            Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
            try {
                ExamActivity.this.startActivity(goToMarket);

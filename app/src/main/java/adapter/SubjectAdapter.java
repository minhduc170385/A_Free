...
public class SubjectAdapter extends BaseAdapter {
    ...
    public List<Subject> getDataForListView()
    {
        ...
        sub.setTitle("AWS-Developer is a package in AWS Certification - Practice Exams have value 20$ and not have answer like AWS-Architect");
        sub.setCode("Note");
        subjects.add(sub);

...
import com.awsdevelop.ducbm.awsexamdevelop.R;
...
public class ExamAdapter extends BaseAdapter {
    ...
    private int number;
    public ExamAdapter(Context context, Question q, int totalCount,String subjectLanguage, int number) {
   ...
   // }
    ...
    private void DisplayAnswer(String answer)
    {
        if (!subjectlanguage.equals("AWS-ArchitectExam") || number>4)
        {
            ...
            Toast toast = Toast.makeText(ctx, "Please buy full version", Toast.LENGTH_SHORT);
            toast.show();
